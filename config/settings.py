...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-kt38_x0j3)_(14xh5!$&u-v+6ht+cw8i14(mrd28=r=1dla4tq')
...
MSDS_API_KEY = config('MSDS_API_KEY', default=PUBLIC_DATA_API_KEY)
