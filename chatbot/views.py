...
def build_briefing_reply(user_message):
    ...
    return sanitize_reply(
        "좋아요. 오늘 출근 전에 이것만 챙겨볼게요.\n"
        f"1. {weather_line}\n"
        f"2. {site_line}\n"
        "3. 안전모, 안전화, 장갑, 물은 출발 전에 한 번만 더 확인하세요.\n"
        "4. 다치거나 어지러우면 참지 말고 119를 먼저 부르세요. 앱의 긴급 도움에서 가까운 응급실도 볼 수 있어요.\n"
        f"5. {center_line}\n"
        "산재나 임금 문제는 혼자 판단하지 말고 1350이나 현장 관리자에게 꼭 확인하세요."
    )
